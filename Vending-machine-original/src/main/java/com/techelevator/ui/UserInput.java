...
public class UserInput {
    ...
    public static final int MM_SALE_REPORT = 3;
    ...
    static final List<Integer> VALID_MAIN_MENU_OPTION = new ArrayList<>(Arrays.asList(MM_DISPLAY_OPTION, MM_PURCHASE_OPTION, MM_SALE_REPORT, MM_EXIT));
